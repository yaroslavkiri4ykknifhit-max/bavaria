            ...
            {[
              {
                ...
                age: "42 года",
                car: "BMW X5 3.0d (F15)",
                title: "Боль дизелистов: забитый DPF и аварийный режим",
              ...
              },
              {
                ...
                age: "",
                car: "BMW 528i (F10)",
                title: "Боль бензиновых моторов: чек энджин и катализатор",
              ...
              },
              {
                ...
                age: "Минск",
                car: "BMW 320d (F30)",
                title: "Боль «гонщиков»: страх за ресурс после Stage 1",
              ...
              <div key={i} className="bg-[#fafafa] border border-[#eee] p-5">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="text-xs text-[#ccc]">{review.date}</div>
                </div>
                <h3 className="text-sm font-bold text-[#e11d48] mb-2">{review.title}</h3>
