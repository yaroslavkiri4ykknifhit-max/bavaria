...
export default function CatalogPage() {
  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="max-w-[1100px] mx-auto px-4 sm:px-6 py-10 md:py-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-[#fafafa] border border-[#eee] p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-[#aaa]">{review.car}</div>
                  </div>
                  <div className="ml-auto text-xs text-[#ccc]">{review.date}</div>
                </div>
                <div className="flex gap-0.5 mb-2">
                  {[...Array(review.rating)].map((_, j) => (
                    <svg key={j} width="14" height="14" viewBox="0 0 24 24" fill="#e11d48" stroke="none">
      ...
      {/* CTA */}
      <section className="max-w-[1100px] mx-auto px-4 sm:px-6 py-10 md:py-14">
        <div className="bg-[#111] px-6 py-8 md:px-10 md:py-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h3 className="text-lg font-bold text-white mb-1">Не нашли свою модель?</h3>
            <p className="text-white/40 text-sm">Позвоните — подберем решение для любого BMW</p>
          </div>
          <a 
            href="tel:+375291234567" 
            className="flex items-center gap-2 bg-[#e11d48] hover:bg-[#be123c] text-white font-bold px-6 py-3 text-sm transition-colors"
          >
